...
import bbms.framework.AbstractNotifiableEntity;
 ...
 *
 */
public class CommonNotifiableEntity extends AbstractNotifiableEntity{
	 ...
	 */
	public CommonNotifiableEntity(Configuration config, String id, int sense) 
	throws RemoteException {
		super(config);
		this.id = id;
		this.sense = sense;
